...
tauri_config_path="${3:-frontend/src-tauri/tauri.conf.json}"
...
install -m 0755 "docs/assets/macos/Open CodexManager.command" "$stage_dir/Open CodexManager.command"
install -m 0644 "docs/assets/macos/README-macOS-first-launch.txt" "$stage_dir/README-macOS-first-launch.txt"
