...
pub use gateway::{
    ...
    default_gateway_user_agent, default_gateway_user_agent_version, fetch_codex_latest_version,
    ...
    set_gateway_upstream_proxy_bypass_hosts, set_gateway_upstream_proxy_enabled,
