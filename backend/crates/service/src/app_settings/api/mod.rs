...
pub(super) use super::gateway::{
    ...
    current_gateway_user_agent, current_gateway_user_agent_version, default_gateway_originator,
    default_gateway_user_agent, default_gateway_user_agent_version, residency_requirement_options,
    ...
    set_gateway_user_agent, set_gateway_user_agent_version, BackgroundTasksInput, QuotaGuardInput,
};
