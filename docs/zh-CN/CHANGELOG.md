...
- 会话分流遇到明确额度耗尽时，会在冷却原账号的同一事务内按当前负载和分流权重自动重新绑定可用账号；额度错误会在交付 Codex 前被拦截，原请求使用新账号自动重发，无需手动换号。
- 恢复账号列表四个环形额度下方的实时重置倒计时，同时保持标准额度与备用额度的紧凑两行布局。
- 补齐 OpenAI 马尼拉边缘机房 `MNL` 的国家、IANA 时区、Windows 时区与语言映射，避免出口画像自动同步持续报未映射错误。
- 账号列表额度区改为固定展示标准额度与备用额度两行，每行使用环形进度直接呈现 5 小时和 7 天窗口，并移除重复的展开明细。

## [0.6.4] - 2026-09-09

- 精简会话双栏布局，直接展示账号切换与绑定重置，支持复制会话 ID 和项目路径。
- 账号主额度条显示实时重置倒计时，缺失或到期状态明确显示。
- 服务端按账号和周期持久化调度重置后预热，手动重置成功后也会预热并刷新额度。
- 补齐倒计时与复制操作的多语言文案。
...
[Unreleased]: https://github.com/16dongdong/SprakCodex
[0.5.4]: https://github.com/16dongdong/SprakCodex
[0.5.3]: https://github.com/16dongdong/SprakCodex
[0.5.2]: https://github.com/16dongdong/SprakCodex
[0.5.1]: https://github.com/16dongdong/SprakCodex
[0.5.0]: https://github.com/16dongdong/SprakCodex
[0.4.4]: https://github.com/16dongdong/SprakCodex
[0.4.3]: https://github.com/16dongdong/SprakCodex
[0.4.2]: https://github.com/16dongdong/SprakCodex
[0.4.1]: https://github.com/16dongdong/SprakCodex
[0.4.0]: https://github.com/16dongdong/SprakCodex
[0.3.9]: https://github.com/16dongdong/SprakCodex
[0.3.8]: https://github.com/16dongdong/SprakCodex
[0.3.7]: https://github.com/16dongdong/SprakCodex
[0.3.6]: https://github.com/16dongdong/SprakCodex
[0.3.5]: https://github.com/16dongdong/SprakCodex
[0.2.6]: https://github.com/16dongdong/SprakCodex
[0.2.3]: https://github.com/16dongdong/SprakCodex
[0.2.0]: https://github.com/16dongdong/SprakCodex
[0.1.19]: https://github.com/16dongdong/SprakCodex
[0.1.17]: https://github.com/16dongdong/SprakCodex
[0.1.16]: https://github.com/16dongdong/SprakCodex
[0.1.15]: https://github.com/16dongdong/SprakCodex
[0.1.14]: https://github.com/16dongdong/SprakCodex
[0.1.13]: https://github.com/16dongdong/SprakCodex
[0.1.12]: https://github.com/16dongdong/SprakCodex
[0.1.11]: https://github.com/16dongdong/SprakCodex
[0.1.10]: https://github.com/16dongdong/SprakCodex
[0.1.9]: https://github.com/16dongdong/SprakCodex
[0.1.8]: https://github.com/16dongdong/SprakCodex
[0.1.7]: https://github.com/16dongdong/SprakCodex
[0.1.6]: https://github.com/16dongdong/SprakCodex
[0.1.5]: https://github.com/16dongdong/SprakCodex
[0.1.4]: https://github.com/16dongdong/SprakCodex
