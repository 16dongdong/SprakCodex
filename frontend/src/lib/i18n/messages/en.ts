...
export const EN_MESSAGES: MessageCatalog = {
  "个节点": "nodes",
  "代理组": "Proxy groups",
  "代理组名称": "Proxy group name",
  "代理组名称为空或已存在": "Proxy group name is empty or already exists",
  "代理配置已保存": "Proxy configuration saved",
  "保存全部配置": "Save all settings",
  "内核已停止，目标进程沿用原始出口": "Kernel stopped; target process uses the original egress",
  "内核运行中，mixed-port：{port}": "Kernel running, mixed-port: {port}",
  "内置 mihomo 代理": "Built-in mihomo proxy",
  "原始出口": "Original egress",
  "导入 Clash 节点": "Import Clash nodes",
  "尚未测速": "Not tested",
  "开启代理": "Enable proxy",
  "当前出口": "Current egress",
  "新建代理组": "New proxy group",
  "测试延迟": "Test latency",
  "添加订阅": "Add subscription",
  "粘贴 proxies YAML、裸节点列表或 Base64 订阅内容": "Paste proxies YAML, a raw node list, or Base64 subscription content",
  "组内当前节点": "Selected group node",
  "自动选择首个节点": "Automatically select the first node",
  "节点": "Nodes",
  "解析并导入": "Parse and import",
  "订阅": "Subscriptions",
  "订阅名称": "Subscription name",
  "设为出口": "Set as egress",
  "请填写订阅名称和地址": "Enter a subscription name and URL",
  "链式入口": "Chain entry",
  "OpenAI 边缘服务器": "OpenAI edge server",
  "Windows 时区": "Windows time zone",
  "仅在出口画像发生变化时更新": "Updated only when the egress profile changes",
  "出口 IANA 时区": "Egress IANA time zone",
  "出口 IP": "Egress IP",
  "出口国家或地区": "Egress country or region",
  "出口画像自动同步": "Automatic egress profile sync",
  "出口语言": "Egress language",
  "同步到 Locale API 与 OpenAI 请求头": "Synced to Locale APIs and OpenAI request headers",
  "同步到请求头与 Chromium/Node": "Synced to request headers and Chromium/Node",
  "实时发布给 DLL 的动态时区键": "Live Windows dynamic time-zone key published to the DLL",
  "已停用": "Disabled",
  "已记录请求": "Recorded requests",
  "当前出口画像": "Current egress profile",
  "探针请求经过的实际代理出口": "Actual proxy egress used by the probe",
  "最近探针失败": "Latest probe failed",
  "最近探针时间": "Latest probe time",
  "来自 OpenAI 边缘探针 loc 字段": "From the OpenAI edge probe loc field",
  "每 {seconds} 秒请求一次 OpenAI 边缘": "Probe the OpenAI edge every {seconds} seconds",
  "画像同步运行期内完成写入的请求": "Requests written during the profile sync runtime",
  "画像更新时间": "Profile updated at",
  "目标进程系统与架构保持原值": "The target process keeps its original system and architecture",
  "等待自动探针": "Waiting for automatic probe",
  "自动探测 OpenAI 实际边缘出口，并实时同步时区和语言到目标进程": "Automatically probe the actual OpenAI edge egress and sync its time zone and language to the target process",
  "自动探针运行正常；代理节点变化后会更新请求头和 DLL 画像。": "The automatic probe is healthy. Proxy node changes update request headers and the DLL profile.",
  "运行平台": "Runtime platform",
  "设备画像": "Device profile",
  "数值越小，分流优先级越高": "Lower values receive higher routing priority",
  "的名称与分流权重。": " name and routing weight.",
  "自动预热": "Automatic warmup",
  "分流方式": "Routing mode",
  "会话标识": "Session identifier",
  "实际使用账号": "Effective account",
  "个人工具": "Personal tools",
  "本机接入": "Local access",
  "可用账号：{available}/{total}": "Available accounts: {available}/{total}",
  "活跃绑定：{count}": "Active bindings: {count}",
  "会话账号分流": "Session account routing",
  "关闭时保留 Codex 原始凭据并记录；开启后仅为新会话均衡分配账号，同一会话保持固定绑定。": "When disabled, preserve and record the original Codex identity. When enabled, balance only new sessions and keep each session bound to one account.",
  "绑定 {count}": "Bindings {count}",
  "参与分流": " participates in routing",
  "读取会话分流状态失败": "Failed to read session routing status",
  "管理应用行为、网络出口、费用显示和技术诊断": "Manage application behavior, network egress, cost display, and diagnostics",
  "个人 Codex 账号管理与会话分流工具": "Personal Codex account and session routing tool",
  "账号和会话分流由 CM 处理，会话、项目、模型、Skills 与插件继续由 Codex 管理。": "CM handles accounts and session routing. Codex continues to manage sessions, projects, models, Skills, and plugins.",
  "设置已保存": "Settings saved",
  "启动完成后在后台检查更新": "Check for updates after startup",
  "系统登录后自动启动桌面端": "Start the desktop app after system sign-in",
  "关闭后从托盘按需打开主界面": "Open the main window from the tray when needed",
  "保留本机接入和会话分流后台运行": "Keep local access and session routing running in the background",
  "请求头": "Request headers",
  ...
  "排队中": "Queued",
  "预检中": "Preflight...",
  "请求 Token 曲线": "Request Token trend",
  "最近 100 条请求 · 单次 Token 用量": "Latest 100 requests · Tokens per request",
  "标头": "Headers",
  "事件流": "Event stream",
  "筛选正文行": "Filter body lines",
  "格式化": "Format",
  "自动换行": "Wrap lines",
  "复制": "Copy",
  "无匹配结果": "No matches",
  "按本地价格表估算，非实际账单": "Estimated from local prices, not an actual bill",
  "非缓存输入": "Uncached input",
  "输出 Token": "Output Token",
  "包含每次请求的历史上下文；缓存属于输入，推理属于输出，不重复相加。": "Includes historical context in each request. Cache is part of input; reasoning is part of output, not added again.",
  "本月": "This month",
  "本周": "This week",
  "本日": "Today",
  "累计 Token": "Cumulative Token",
  "累计费用": "Cumulative cost",
  "累计成功请求": "Cumulative successful requests",
  "总计": "Total",
  "网络": "Network",
  "诊断": "Diagnostics",
  "关于": "About",
  ...
  "会话记录已不存在": "Session record no longer exists",
  "已安排切换，将在当前请求结束后生效": "Switch scheduled after the current request completes",
  "首次分配": "Initial assignment",
  "手动切换": "Manual switch",
  "额度耗尽": "Quota exhausted",
  "账号不可用": "Account unavailable",
  "暂无可用账号": "No available accounts",
  "搜索会话 ID": "Search session ID",
  "仅显示已接入会话；重置绑定不删除 Codex 聊天内容。": "Only observed sessions are listed. Resetting a binding does not delete Codex chat history.",
  "会话 ID": "Session ID",
  "绑定账号": "Bound account",
  "最近活动": "Last activity",
  "首次连接": "First connected",
  "迁移原因": "Migration reason",
  ...
  "删除此分流记录，下次连接重新分配账号；不会删除聊天内容。当前请求保持原账号直到结束。": "Remove this routing record and assign an account on the next connection. Chat history is preserved. The current request keeps its account until completion.",
  "当前请求结束后切换连接，不重放已经发送的请求。": "Reconnect after the current request completes. Already sent requests are not replayed.",
  "关联活跃会话：{count}": "Active bound sessions: {count}",
  "关联会话将在下次请求时重新分配账号，聊天内容保留。": "Related sessions will be reassigned on their next request. Chat history is preserved.",
  "按提供对应窗口的可用账号取平均": "Average across available accounts that report this window",
  "分流已关闭": "Routing disabled",
  "未分流": "Not routed",
  "搜索会话标题或 ID": "Search session title or ID",
  "项目筛选": "Project filter",
  "所有项目": "All projects",
  ...
  归属成员: "Owner member",
  "直连观测": "Direct observation",
  "启用观测": "Enable observation",
