...
export const KO_MESSAGES: MessageCatalog = {
  ...
  "代理组": "프록시 그룹",
  "代理组名称": "프록시 그룹 이름",
  "代理组名称为空或已存在": "그룹 이름이 비어 있거나 이미 존재합니다",
  "代理配置已保存": "프록시 구성이 저장되었습니다",
  "保存全部配置": "전체 구성 저장",
  "内核已停止，目标进程沿用原始出口": "커널이 중지되어 원래 출구를 사용합니다",
  "内核运行中，mixed-port：{port}": "커널 실행 중, mixed-port: {port}",
  "内置 mihomo 代理": "내장 mihomo 프록시",
  "原始出口": "원래 출구",
  "导入 Clash 节点": "Clash 노드 가져오기",
  "尚未测速": "측정 안 됨",
  "开启代理": "프록시 사용",
  "当前出口": "현재 출구",
  "新建代理组": "새 프록시 그룹",
  "测试延迟": "지연 시간 테스트",
  "添加订阅": "구독 추가",
  "粘贴 proxies YAML、裸节点列表或 Base64 订阅内容": "proxies YAML, 노드 목록 또는 Base64 구독 내용을 붙여넣으세요",
  "组内当前节点": "그룹의 현재 노드",
  "自动选择首个节点": "첫 번째 노드 자동 선택",
  "节点": "노드",
  "解析并导入": "분석 후 가져오기",
  "订阅": "구독",
  "订阅名称": "구독 이름",
  "设为出口": "출구로 설정",
  "请填写订阅名称和地址": "구독 이름과 주소를 입력하세요",
  "链式入口": "체인 입구",
  "分流权重": "라우팅 가중치",
