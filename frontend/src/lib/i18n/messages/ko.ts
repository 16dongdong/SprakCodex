...
export const KO_MESSAGES: MessageCatalog = {
  "代理地址": "프록시 주소",
  "代理设置已生效": "프록시 설정이 적용되었습니다",
  "开启代理": "프록시 사용",
  "开启代理前请先填写代理地址": "프록시를 사용하기 전에 주소를 입력하세요",
  "当前沿用目标进程或系统代理出口": "현재 대상 프로세스 또는 시스템 프록시 출구 사용 중",
  "影响范围": "적용 범위",
  "支持 HTTP CONNECT 与 SOCKS5 地址；启用后不会再使用系统代理。": "HTTP CONNECT 및 SOCKS5 주소를 지원합니다. 활성화하면 시스템 프록시를 사용하지 않습니다.",
  "显示代理地址": "프록시 주소 표시",
  "目标进程、OpenAI 请求与画像探针": "대상 프로세스, OpenAI 요청 및 프로필 프로브",
  "目标进程和 OpenAI 探针当前使用自定义代理出口": "대상 프로세스와 OpenAI 프로브가 사용자 지정 프록시 출구를 사용 중입니다",
  "系统代理或原始出口": "시스템 프록시 또는 원래 출구",
  "自定义代理": "사용자 지정 프록시",
  "自定义代理出口": "사용자 지정 프록시 출구",
  "隐藏代理地址": "프록시 주소 숨기기",
  "分流权重": "라우팅 가중치",
  "OpenAI 边缘服务器": "OpenAI 엣지 서버",
  "Windows 时区": "Windows 시간대",
  "仅在出口画像发生变化时更新": "출구 프로필이 변경될 때만 업데이트",
  "出口 IANA 时区": "출구 IANA 시간대",
  "出口 IP": "출구 IP",
  "出口国家或地区": "출구 국가 또는 지역",
  "出口画像自动同步": "출구 프로필 자동 동기화",
  "出口语言": "출구 언어",
  "同步到 Locale API 与 OpenAI 请求头": "Locale API 및 OpenAI 요청 헤더에 동기화",
  "同步到请求头与 Chromium/Node": "요청 헤더와 Chromium/Node에 동기화",
  "实时发布给 DLL 的动态时区键": "DLL에 실시간 게시되는 동적 시간대 키",
  "已停用": "비활성화됨",
  "已记录请求": "기록된 요청",
  "当前出口画像": "현재 출구 프로필",
  "探针请求经过的实际代理出口": "프로브 요청이 사용한 실제 프록시 출구",
  "最近探针失败": "최근 프로브 실패",
  "最近探针时间": "최근 프로브 시간",
  "来自 OpenAI 边缘探针 loc 字段": "OpenAI 엣지 프로브 loc 필드에서 가져옴",
  "每 {seconds} 秒请求一次 OpenAI 边缘": "{seconds}초마다 OpenAI 엣지 프로브",
  "画像同步运行期内完成写入的请求": "프로필 동기화 실행 중 기록된 요청",
  "画像更新时间": "프로필 업데이트 시간",
  "目标进程系统与架构保持原值": "대상 프로세스의 시스템과 아키텍처는 그대로 유지",
  "等待自动探针": "자동 프로브 대기 중",
  "自动探测 OpenAI 实际边缘出口，并实时同步时区和语言到目标进程": "실제 OpenAI 엣지 출구를 자동으로 탐지하고 시간대와 언어를 대상 프로세스에 실시간 동기화",
  "自动探针运行正常；代理节点变化后会更新请求头和 DLL 画像。": "자동 프로브가 정상입니다. 프록시 노드가 변경되면 요청 헤더와 DLL 프로필이 업데이트됩니다.",
  "运行平台": "실행 플랫폼",
  "设备画像": "장치 프로필",
  "数值越小，分流优先级越高": "값이 작을수록 라우팅 우선순위가 높습니다",
  "的名称与分流权重。": " 이름과 라우팅 가중치입니다.",
  "自动预热": "자동 워밍업",
  "分流方式": "라우팅 방식",
  "会话标识": "세션 식별자",
  "实际使用账号": "실제 사용 계정",
  ...
  "请求体": "요청 본문",
  "响应体": "응답 본문",
  "未采集到该请求的网络报文": "이 요청의 네트워크 메시지가 수집되지 않았습니다",
  "仅收到客户端完成事件；该记录没有网络报文，需重新接入后采集新请求。": "클라이언트 완료 이벤트만 수신되었습니다. 이 기록에는 네트워크 메시지가 없으며 다시 연결한 후 새 요청을 수집해야 합니다.",

  "输出": "출력",
  "保留原登录与上游，记录请求和用量；重启自动恢复。": "기존 로그인과 업스트림을 유지하고 요청과 사용량을 기록하며 재시작 후 복원합니다.",
  "此记录未采集请求和响应正文。": "이 기록의 요청 및 응답 본문은 수집되지 않았습니다.",
  "记录与诊断": "기록 및 진단",
  "客户端完成事件": "클라이언트 완료 이벤트",
  "请求": "요청",
  "响应": "응답",
  "请求详情": "요청 상세",
  "支持整段导入 /api/auth/session JSON、auth.json 或 Refresh Token。有刷新凭据时自动续期；仅 Access Token 过期后需重新授权。": "/api/auth/session JSON, auth.json 또는 Refresh Token을 붙여넣으세요. 갱신 자격 증명이 있으면 자동 갱신하며 Access Token만 있으면 만료 후 다시 인증해야 합니다.",

  客户端事件: "클라이언트 이벤트",
  "Windows 自动接入已有和新启动的 Codex；已接入客户端的完成事件可在宿主恢复后补录。": "Windows에서 실행 중이거나 새로 시작한 Codex를 자동 관측합니다. 연결된 클라이언트의 완료 이벤트는 호스트가 다시 시작된 후 복구할 수 있습니다.",
  "退出应用不等于关闭观测；需停止记录时，请先点击“关闭观测”。": "앱을 종료해도 관측은 해제되지 않습니다. 기록을 중지하려면 먼저 관측 끄기를 클릭하세요.",
  ...
  "请求 Token 曲线": "요청 Token 추이",
  "最近 100 条请求 · 单次 Token 用量": "최근 요청 100개 · 요청별 Token 사용량",
  "标头": "헤더",
  "事件流": "이벤트 스트림",
  "筛选正文行": "본문 줄 필터",
  "格式化": "서식",
  ...
  "复制": "복사",
  "无匹配结果": "일치 결과 없음",
  "按本地价格表估算，非实际账单": "로컬 가격표 추정치이며 실제 청구액이 아닙니다",
  "非缓存输入": "비캐시 입력",
  "输出 Token": "출력 Token",
  "包含每次请求的历史上下文；缓存属于输入，推理属于输出，不重复相加。": "각 요청의 이전 문맥을 포함합니다. 캐시는 입력에, 추론은 출력에 포함되며 중복 합산하지 않습니다.",
  "本月": "이번 달",
  "本周": "이번 주",
  "本日": "오늘",
  "累计 Token": "누적 Token",
  ...
  "会话": "세션",
  "请选择账号": "계정을 선택하세요",
  "会话记录已不存在": "세션 기록이 더 이상 없습니다",
  "已安排切换，将在当前请求结束后生效": "현재 요청 완료 후 계정이 전환됩니다",
  "首次分配": "최초 배정",
  "手动切换": "수동 전환",
  "额度耗尽": "할당량 소진",
  "账号不可用": "계정 사용 불가",
  "暂无可用账号": "사용 가능한 계정 없음",
  "搜索会话 ID": "세션 ID 검색",
  "仅显示已接入会话；重置绑定不删除 Codex 聊天内容。": "연결된 세션만 표시합니다. 바인딩 초기화는 Codex 대화를 삭제하지 않습니다.",
  "会话 ID": "세션 ID",
  "绑定账号": "연결 계정",
  "最近活动": "최근 활동",
  "首次连接": "최초 연결",
  ...
  "重置绑定": "바인딩 초기화",
  "暂无会话记录": "세션 기록 없음",
  "删除此分流记录，下次连接重新分配账号；不会删除聊天内容。当前请求保持原账号直到结束。": "분배 기록을 삭제하고 다음 연결에서 계정을 다시 배정합니다. 대화와 현재 요청은 유지됩니다.",
  "当前请求结束后切换连接，不重放已经发送的请求。": "현재 요청이 끝난 후 연결을 전환하며 이미 보낸 요청은 재전송하지 않습니다.",
  "关联活跃会话：{count}": "연결된 활성 세션: {count}",
  "关联会话将在下次请求时重新分配账号，聊天内容保留。": "연결된 세션은 다음 요청에서 다시 배정됩니다. 대화 내용은 유지됩니다.",
  "按提供对应窗口的可用账号取平均": "해당 기간을 제공하는 사용 가능한 계정의 평균",
  "分流已关闭": "분배 비활성화",
  "未分流": "미배정",
  "搜索会话标题或 ID": "세션 제목 또는 ID 검색",
  "项目筛选": "프로젝트 필터",
  "所有项目": "모든 프로젝트",
  "最近会话": "최근 세션",
  "会话操作": "세션 작업",
