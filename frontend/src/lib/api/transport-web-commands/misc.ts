...
export function createMiscWebCommands(): Record<string, WebCommandDescriptor> {
  return {
    ...
    service_proxy_runtime_config: { rpcMethod: "proxyRuntime/config" },
    service_proxy_runtime_status: { rpcMethod: "proxyRuntime/status" },
    service_proxy_runtime_save: { rpcMethod: "proxyRuntime/save" },
    service_proxy_runtime_parse: { rpcMethod: "proxyRuntime/parse" },
    service_proxy_runtime_fetch: { rpcMethod: "proxyRuntime/fetch" },
