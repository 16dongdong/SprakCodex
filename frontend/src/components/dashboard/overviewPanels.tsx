        ...
        {active && points.length > 0 ? (
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={points} margin={{ top: 16, right: 16, bottom: 4, left: 0 }} accessibilityLayer>
              ...
              <XAxis dataKey="time" tickFormatter={(value) => period === "day" ? new Date(value).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) : period === "week" ? new Date(value).toLocaleDateString([], { weekday: "short" }) : new Date(value).toLocaleDateString([], { month: "2-digit", day: "2-digit" })} minTickGap={50} tickLine={false} axisLine={false} tick={{ fill: "var(--muted-foreground)", fontSize: 11 }} />
